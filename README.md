...
> Hyper check if email was in data breaches

[![PyPI version](https://badge.fury.io/py/hyper-email-leak.svg)](https://pypi.org/project/hyper-email-leak/)
...
```bash
pip install hyper-email-leak
```

## Quick Start

```python
from hyper_email_leak import leak
...
from hyper_email_leak import batch
